...
$(document).ready(function(){$(".grid").masonry({itemSelector:".grid-item"})}),$("a.thumb").click(function(t){t.preventDefault();var e=$(this).attr("href"),r=$(".modal-body");r.empty(),r.html('<img src="'+e+'">'),$(".modal-profile").modal("{show:true}")});
/*!
