...
/*! Custom JS */
function sendToTop(o){$(o).each(function(){$(this).click(function(o){o.preventDefault();var e=$(this).attr("href");console.log(e),$("html,body").animate({scrollTop:$("#"+e).offset().top},1500)})})}function clickStop(o){o.click(function(o){o.stopPropagation()})}("Microsoft Internet Explorer"==navigator.appName||navigator.userAgent.match(/Trident/)||navigator.userAgent.match(/rv:11/)||void 0!==$.browser&&1==$.browser.msie)&&$("html").addClass("ie"),$(document).ready(function(){$(".grid").masonry({itemSelector:".grid-item"})}),$("#myModal").modal("handleUpdate"),$("#myModal").on("show.bs.modal",function(){$(this).find(".modal-body").css({width:"auto",height:"auto","max-height":"100%"})}),sendToTop(".main-menu-item a"),sendToTop(".btn-bilgi"),$(".hamb-menu").click(function(){return $(".main-menu").toggleClass("open"),$(this).toggleClass("closed"),!1}),$(document).click(function(){$(".main-menu").removeClass("open"),$(".hamb-menu").removeClass("closed")}),clickStop($(".main-menu")),$(".film-has-video").click(function(){$(this).css("background-image","none"),$(this).after().hide(),playVideo()}),$("a.plans-link, a.thumb").fancybox({speedIn:600,speedOut:200,padding:0,margin:20,cyclic:!0,overlayColor:"#000",overlayOpacity:"0.9"});
/*!
...
$("#submit").click(function(t){var e=$("#ad").val(),n=$("#soyad").val(),i=$("#tel").val(),a=($("#email").val(),$("#proje").val(),$("#mesaj").val(),/^[A-Za-z]+$/),r=/^[0-9]+$/;$("#ke"),$("#kt");""==e?(swal({title:"Uyarı!",text:"Lütfen adınızı giriniz",type:"warning",confirmButtonText:"OK"}),t.preventDefault()):a.test(e)?""==n?(swal({title:"Uyarı!",text:"Lütfen soyadınızı giriniz",type:"warning",confirmButtonText:"OK"}),t.preventDefault()):a.test(n)?""==i?(swal({title:"Uyarı!",text:"Lütfen telefon numaranızı giriniz",type:"warning",confirmButtonText:"OK"}),t.preventDefault()):r.test(i)?$("#submit").click(function(){return!0}):(swal({title:"Uyarı!",text:"Lütfen geçerli bir telefon numarası giriniz",type:"warning",confirmButtonText:"OK"}),t.preventDefault()):(swal({title:"Uyarı!",text:"Lütfen geçerli bir ad giriniz",type:"warning",confirmButtonText:"OK"}),t.preventDefault()):(swal({title:"Uyarı!",text:"Lütfen geçerli bir ad giriniz",type:"warning",confirmButtonText:"OK"}),t.preventDefault())});